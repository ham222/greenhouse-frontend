...
export default function Vitals({ temperature, co2, humidity, datetime }) {
  return (
    <div className="bg-lime-400 font-sora shadow-lg max-sm:w-auto grid rounded-xl m-3 grid-cols-9 grid-rows-5">
      <div className="col-span-4 row-span-3 border-b border-black border-dashed text-5xl font-bold flex justify-center items-center py-5">
        {temperature}°C
      </div>
      <div className="col-span-5 row-span-3 border-b border-black border-dashed flex items-center justify-center ">
        <div>
          <div className="text-xl font-semibold">Your Greenhouse</div>
          <div className="text-sm">at 10:08 10/12/2023</div>
        </div>
      </div>
